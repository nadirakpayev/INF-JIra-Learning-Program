...
Репозиторий содержит учебную и отборочную программу по `Jira Service Management Cloud`.

Здесь есть два основных контура:
- [INF Learning Programm](INF%20Learning%20Programm/README.md) — основная учебная программа, построенная как последовательные блоки практических заданий;
